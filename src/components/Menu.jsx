...
const Menu = () => {
  return (
    <div style={{ zIndex: '2', width: '95%', height: '30px', backgroundColor: '#9C3587', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', padding: '0em 3em', position: 'fixed' }}>
